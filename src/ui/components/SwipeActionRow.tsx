...
export function SwipeActionRow({
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-3xl">
      <div
        className={`absolute inset-y-0 right-0 flex w-[88px] items-center justify-center bg-mist-800/80 transition-opacity ${
      ...
      >
        <button
          ...
          className="rounded-full border border-mist-600 bg-mist-700 px-3 py-2 text-sm text-mist-100 disabled:cursor-not-allowed disabled:opacity-40"
